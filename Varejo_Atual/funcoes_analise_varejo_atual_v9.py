...
def gerar_df_analysis(rmodelo_fin, cmodelo_fin, pmodelo_fin, pmodelop_fin, cenario, segmentos, anomes_m0, anomes_m1, anomes_m2):
    ...
    segmentos_PF = ['Tot_PF_Ex_Agro','Esp','Prosp','Agr_Sel','Select','Select_Hi']
    segmentos_PJ = ['Emp1','Emp2','Emp3','Emp_MEI','Emp1_Mass','Tot_Gov','Tot_Univ']
...
def validar_exclusivos_pf_pj(rmod_pf, rmod_pj, cenario):
    ...
    exclusivo_pj = ['54', '57', '10016', '31', '44', '46', '10580', '10561', '10482', '10483', '10484', '10485', '10618', '523', '644', '20160', '921', '970', '1130',
                    '41', '38', '394', '530', '37', '388', '529', '34', '35', '52', '10053', '20118', '20120', '20137', '20200', '20117']

    exclusivo_pf = ['22', '40', '17', '18', '19', '10071', '10075', '10588', '10589', '10564', '10565', '10566', '113', '442', 
                    '10654', '510', '511', '614', '718', '20109', '20161', '20113', '60933', '701058', '701063', '1087', '1172', 
                    '1601185', '12', '13', '14', '10015', '10667', '10668', '10670', '504', '505', '506', '20159', '45','10567',
                    '10308', '390', '537', '1144']


    rmodelo_pf = copy.deepcopy(rmod_pf)
    ...
    rmodelo_pj = copy.deepcopy(rmod_pj)
...
def validar_contabil_ficticio_cod_zerados_y0(rmodelo_fin, cenario, num_anos):
    ...
    rmodelo_valid_contab_fict = [df1,df2,df3,df4,df5,df6,df7,df8,df9,df10,df11,df12,df13,df14,df15,df16,df17,df18,df19,df20,df21,df22,df23,df24]
...
def arredondar_0_casas_decimais(row, col):
...
def validar_resultado_e_soma_contabil_ficticio(rmodelo_fin, cenario, num_anos):
    ...
    df1=df2=df3=df4=df5=df6=df7=df8=df9=df10=df11=df12=df13=df14=df15=df16=df17=df18=df19=df20=df21=df22=df23=df24=pd.DataFrame()
    rtotal = [df1,df2,df3,df4,df5,df6,df7,df8,df9,df10,df11,df12,df13,df14,df15,df16,df17,df18,df19,df20,df21,df22,df23,df24]
    rcontabil = copy.deepcopy(rtotal)
    rficticio = copy.deepcopy(rtotal)
    rmerge1 = copy.deepcopy(rtotal)
    rmerge2 = copy.deepcopy(rtotal)
    rfinal = copy.deepcopy(rtotal)
    ...
    for j in range(len(rfinal)):       
        ...
        for f in cols[16:]:         
            rfinal[j][f'{f}_valid'] = rfinal[j].apply(lambda row: arredondar_0_casas_decimais(row, f'{f}_valid'), axis = 1)  
...
def gerar_excel_validadores(MoM_R01, MoM_R02, MoM_P01, rmodelo_pf_valid, rmodelo_pj_valid, valid_contab_fict_zerados_y0, valid_resultado_e_soma_contab_fict, segmentos, cenario, mes_ano_ref, versao):
    ...
    rmodelo_pf_valid.to_excel(writer, sheet_name = 'PF_Valid', index = False)
    rmodelo_pj_valid.to_excel(writer, sheet_name = 'PJ_Valid', index = False)
